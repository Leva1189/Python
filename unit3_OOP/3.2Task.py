...
# Створіть підклас ProEditor, у якому цей метод буде перевизначено. Введіть ліцензійний ключ із клавіатури і, якщо він коректний, створіть екземпляр класу ProEditor, інакше Editor. 
...
#         print("Перегляд документів доступний для всіх користувачів.")
...
#     def edit_document(self):
#         print("Редагування документів доступне для Pro користувачів.")
#     def __init__(self):
#         self.license_key = input("Введіть ліцензійний ключ: ")
#         if self.license_key == "12345":
#             self.editor = ProEditor()
#         else:
#             self.editor = Editor()

# doc = ProEditor()
# doc.editor.view_document()
# doc.editor.edit_document()    
